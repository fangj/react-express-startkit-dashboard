/**
 * Created by FangJian on 2017/11/13.
 */
...
class Pdf extends React.Component {
    ...
    onDocumentComplete = (pdf) => {
        ...
        // Promise.all(pageNumArr.map(pdf.getPage)).then(pages=>{
        //     this.setState({pages});
        //     this.renderAllPage();
        // }).catch(e=>{
        //     console.log(e)
        ...
        Promise.all(pageNumArr.map(i=>pdf.getPage(i))).then(pages=>{
                this.setState({pages});
                this.renderAllPage();
            }).catch(e=>{
                console.log(e)
